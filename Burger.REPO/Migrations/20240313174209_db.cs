    ...
    public partial class db : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HamburgerExtras", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HamburgerExtras_Extras_ExtraId",
                        column: x => x.ExtraId,
                        principalTable: "Extras",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HamburgerExtras_Hamburger_HamburgerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuHamburgers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuHamburgers_Hamburger_HamburgerId",
                        column: x => x.HamburgerId,
                        principalTable: "Hamburger",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuHamburgers_Menus_MenuId",
                        column: x => x.MenuId,
                        principalTable: "Menus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderHamburgers_Hamburger_HamburgerId",
                        column: x => x.HamburgerId,
                        principalTable: "Hamburger",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HamburgerExtras_ExtraId",
                table: "HamburgerExtras",
                column: "ExtraId");

            migrationBuilder.CreateIndex(
                name: "IX_HamburgerExtras_HamburgerId",
                table: "HamburgerExtras",
                column: "HamburgerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuHamburgers_HamburgerId",
                table: "MenuHamburgers",
                column: "HamburgerId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuHamburgers_MenuId",
                table: "MenuHamburgers",
                column: "MenuId");
